...
#define CONFIG_SOC_RTC_GPIO_EDGE_WAKEUP_SUPPORTED 1
...
#define CONFIG_SOC_RTC_TIMER_V2 1
...
#define CONFIG_SOC_PM_TOP_DEPENDS_ON_RTC_PERIPH 1
...
#define CONFIG_SOC_LP_CORE_SUPPORT_I2C 1
